...
public class HomePage 
{
	...
	{
		if(ReusableMethods.getElements(HomePageUI.customerStories, driver))
		{
			if(ReusableMethods.click(HomePageUI.customerStories, driver))
			{
				log.info("Customer Stories button found and clicked");
				return true;
			}
		}
		return false;
